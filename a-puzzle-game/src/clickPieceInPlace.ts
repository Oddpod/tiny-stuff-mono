...
export function clickPieceIntoPlace({ pieceId, left, top, boundingBox, definition, pieceSize }: ClickPieceIntoPlaceParams) {
    // TODO: Readjust corner piece if inside boundingbox
    ...
    // TODO: Check if boundingboxes overlap by such and such, but only for corner pieces
    // The other pieces have to be "clicked" together.
